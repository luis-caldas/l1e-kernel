...
/*                                  
                                                                                                                 */
#if defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L_DCM) || defined(CONFIG_MACH_MSM8960_L0) || defined(CONFIG_MACH_MSM8960_D1LV)||defined(CONFIG_MACH_MSM8960_L1E)
...
#endif
#else
#if defined (CONFIG_MACH_MSM8960_L1A ) || defined (CONFIG_MACH_MSM8960_L1E)
			val->intval = 75;
...
#if defined(CONFIG_MACH_MSM8960_L_DCM) | defined(CONFIG_MACH_MSM8960_D1LV)
...
/*                                  */
			...
			rtnValue = 0;
			wireless_current_set(chip);
			#if defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L_DCM)  || defined(CONFIG_MACH_MSM8960_D1LV)
...
#ifndef CONFIG_MACH_MSM8960_L1E
		/*           
...
//                                                         
// please refer to the commit ID e4b58603 (kideok.kim 2013-01-11 18:31:11 +0900 4334) in android/kernel_la17/drivers/power/pm8921-charger.c
// and commit ID 7d995818 (Xiaozhe Shi 2012-10-11 15:49:58 -0700 in android/kernel_la10/drivers/power/pm8921-charger.c
#ifndef QCT1740J_LA10_CONFIRM_4_D1LV
	...
	vbat_batt_terminal_uv = vbat_meas_uv
					+ ichg_meas_ma
					* the_chip->rconn_mohm;
#endif // #ifndef QCT1740J_LA10_CONFIRM_4_D1LV
//                                                       
...
#else // #ifndef QCT1740J_LA10_CONFIRM_4_D1LV
...
/*                                  
                                                                                  */
#if defined(CONFIG_MACH_MSM8960_D1LU) || defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L_DCM)|| defined(CONFIG_MACH_MSM8960_L0) || defined(CONFIG_MACH_MSM8960_D1LV)
	rc = pm_chg_masked_write(chip, CHG_CNTRL_2,
				CHG_BAT_TEMP_DIS_BIT, CHG_BAT_TEMP_DIS_BIT);
#else
	rc = pm_chg_masked_write(chip, CHG_CNTRL_2,
...
#if defined(CONFIG_MACH_MSM8960_L1E)	
